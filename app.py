...
demo = gr.ChatInterface(
    fn=responder,
    title="Soy David Hernández - Master en Contabilidad y Auditoría.",
    description="Soy David Hernández, una Inteligencia Artificial desarrollada por el Prof. Víctor Campos | CI V-8270225.",
    examples=ejemplos,
